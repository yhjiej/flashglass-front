...
"[project]/src/constants/global.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$global$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/constants/global.ts [app-ssr] (ecmascript)");
...
function translateAnyObject(arr, locale) {
    ...
    arr?.forEach((obj, index)=>Object?.keys(obj).forEach((key)=>{
            if (key === 'translations' && Array.isArray(obj[key])) {
                const translated = obj[key].find((translation)=>translation.languages_code === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$global$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DIRECTUS_LOCALES"][locale]);
...
const toastVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cva"])('group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-y-0 data-[swipe=end]:translate-y-[var(--radix-toast-swipe-end-y)] data-[swipe=move]:translate-y-[var(--radix-toast-swipe-move-y)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-top-full data-[state=open]:slide-in-from-bottom-full data-[state=open]:sm:slide-in-from-top-full', {
    variants: {
        variant: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3b8b62._.js.map